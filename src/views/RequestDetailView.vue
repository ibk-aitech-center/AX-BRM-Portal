...
const judgement = computed(() => {
  ...
  const override = d.value.reviews.find((r) => r.judgementOverride)?.judgementOverride;
  return override ? { ...d.value.request.judgement, ...override } : d.value.request.judgement;
});
